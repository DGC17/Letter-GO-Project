package LetterGoProject.LetterGOResponses;
...
public abstract class AbstractStatusType implements StatusType {
     ...
     */
    public AbstractStatusType(final Family family0, final int statusCode0,
     ...
     * @param reasonPhrase0 Reason Phrase. 
     */
    protected AbstractStatusType(final Status status0,
                                 final String reasonPhrase0) {
